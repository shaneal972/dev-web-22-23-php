...
<head>
    ...
    <title>ShanCine - Mon site de films</title>
    <!--  Google fonts  -->
...
<body>
    <div class="container">
        <header>
            <h1 class="text-uppercase fs-4">ShanCine</h1>
            <p class="text-muted">Vos films préférés</p>
        </header>
        <main>
                ...
                <ul class="list-group list-group-horizontal justify-content-center mb-4">
                    <?php foreach ($yearList as $year): ?>
                        <li class="list-group-item">
                            <a class="text-decoration-none btn btn-success" href="index.php?year=<?php echo $year; ?>"><?php echo $year; ?></a>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </section>
            <section class="d-flex justify-content-evenly">
                ...
                ?>
                        <div class="card" style="width: 18rem;">
                            <img src="./images/<?php echo $movie['image'] ?>" class="card-img-top" alt="Image du film <?php echo $movie['title'] ?>" width="183" height="275">
                            <div class="card-body">
